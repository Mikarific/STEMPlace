...
window.App = (function() {
  ...
  const uiHelper = (function() {
    const self = {
      ...
      specialChatColorClasses: ['rainbow', ['donator', 'donator--green'], ['donator', 'donator--gray'], ['event', 'event--hothot'], ['event', 'event--nebula'], 'trans'],
      init: function() {
  ...
  const chat = (function() {
    const self = {
      ...
      _populateUsernameColor: () => {
        ...
        const hasAllEventColors = hasPermForColor('event') || hasPermForColor('event.*');
        self.elements.username_color_select.empty().append(
          ...
          hasAllEventColors || hasPermForColor('event.hothot') ? crel('option', { value: -4, class: 'event event--hothot' }, '*. HotHot Event') : null,
          hasAllEventColors || hasPermForColor('event.nebula') ? crel('option', { value: -5, class: 'event event--nebula' }, '*. Nebula Event') : null,
          hasPermForColor('trans') ? crel('option', { value: -6, class: 'trans' }, '*. Trans') : null,
  ...
  const user = (function() {
    const self = {
      ...
      isEvent: () => self.hasPermission('user.event'),
